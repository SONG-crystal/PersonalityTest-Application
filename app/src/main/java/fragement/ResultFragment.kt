...
class ResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tv_main = view.findViewById<TextView>(R.id.tv_main)
        val tv_sub = view.findViewById<TextView>(R.id.tv_sub)

        setResult(option, tv_main, tv_sub)
    ...
    private fun setResult(option:Int, tv_main: TextView, tv_sub: TextView){
        when(option){

            1->{
                tv_main.text ="You are QUITTER!"
